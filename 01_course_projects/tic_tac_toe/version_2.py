...
class TicTacToeGame:
    def __init__(self, master):
        ...
        self.new_game_button = tk.Button(self.control_frame, text="New Game", command=self.reset_game, font=('Arial', 14))
        ...
        self.difficulty_menu.config(font=('Arial', 14))
        ...
        self.mode_menu.config(font=('Arial', 14))
